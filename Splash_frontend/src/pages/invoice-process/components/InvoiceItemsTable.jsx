          ...
          <table className="w-full text-left border-separate border-spacing-y-2">
            <thead>
              <tr className="text-gray-500 text-xs uppercase tracking-widest">
                ...
                <th className="px-4 py-2  w-[15%]">Miktar</th>
                <th className="px-4 py-2 text-center w-[2%]">Birim</th>
                <th className="px-4 py-2 w-[20%]">Birim Fiyat</th>
                <th className="px-4 py-2  w-[8%]">KDV %</th>
                <th className="px-4 py-2 text-right w-[1%]">KDV Tutarı</th>
                <th className="px-4 py-2 text-right  w-[20%]">Satır Toplamı</th>
            ...
            <tbody>
              {(Array.isArray(items) ? items : []).map((item, i) => (
                <tr key={i} className="bg-gray-800/50 group">
                  ...
                  <td className="px-4 py-3">
                    <select
                      className="bg-gray-900 border border-gray-700 rounded-lg px-2 py-2 text-[14px] font-bold text-blue-400 outline-none focus:border-blue-500 cursor-pointer w-24"
                      value={item?.unit || "KG"}
                      onChange={(e) =>
